...
You can store the `ov-classification.py` file that we will be creating wherever you want on you device. For simplicity, this guide will create it along with some test images inside a directory under the user's home directory; `~/edge-inference-intro`.
